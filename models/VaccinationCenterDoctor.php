<?php
    class VaccinationCenterDoctor extends User {
         ...
         * αντιστοιχούν στα πεδία doctor_Id, vaccination_center_id του πίνακα
         ...
         * VaccinationCenterDoctor, δίνοντας default τιμές null στα πεδία vaccinationCenter και doctorId
         * γιατί ο γιατρός πρέπει να επιλέξει μόνος του το κέντρο εμβολιασμού που εργάζεται, άρα το πεδίο
         * μπορεί να είναι κοινό, έτσι δεν υπάρχει εγγραφή στο db και δεν μπορεί να υπάρχει ούτε doctor_Id
         * στην περίπτωση αυτή.
         */
